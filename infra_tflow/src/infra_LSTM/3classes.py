...
Extracts classes 1, 2, and 4 of Alaska dataset 
...
# only keep classes 1, 2, and 4 
temp = np.append(data_train[data_train[:,0] == 2],data_train[data_train[:,0] == 4],axis=0) 
data_train = np.append(temp,data_train[data_train[:,0] == 1],axis=0) 
temp = np.append(data_test[data_test[:,0] == 2],data_test[data_test[:,0] == 4],axis=0) 
data_test = np.append(temp,data_test[data_test[:,0] == 1],axis=0) 
...
# re-index classes 1, 2, and 4 to 0, 1, and 2, respectively 
