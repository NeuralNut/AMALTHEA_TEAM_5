...
#    dataset='Two_Patterns'
    X_train,train_seq,X_val,val_seq,X_test,test_seq,y_train,y_val,y_test = load_data(root_direc,ratio,dataset_name)
    ...
    config = {'num_layers':2, # number of hidden LSTM layers
              'hidden_size':5, # number of units in each layer
    ...
    with tf.Session() as sess:
        ...
        plt.title("%s \n Test accuracy: %f"%(dataset_name,test_acc))
